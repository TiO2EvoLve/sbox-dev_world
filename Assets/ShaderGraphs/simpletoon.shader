...
PS
{
	...
	float g_flbrightness < UiType( Slider ); UiStep( 1 ); UiGroup( ",0/,0/0" ); Default1( 2 ); Range1( 1, 10 ); >;
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float2 l_1 = TileAndOffsetUv( l_0, float2( 1, 1 ), float2( 0, 0 ) );
		float4 l_2 = Tex2DS( g_tColor, g_sSampler0, l_1 );
		float l_3 = g_flbrightness;
